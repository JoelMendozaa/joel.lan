<?php
    ...
    class UsuariosCRUD extends ProgramaBase
    {
        ...
        function inicializar()
        {
            ...
            $email       = new Textarea('email'  ,['placeholder' => 'Email...', 'validar' => True, 'ereg' => EREG_TEXTO_100_OBLIGATORIO ]);
            $edad        = new Input   ('edad'        ,['placeholder' => 'Edad...'      , 'validar' => True , 'ereg' => EREG_TEXTO_100_OBLIGATORIO  ]);
        ...
        function resultados_busqueda()
        {
            ...
            $limite = UsuariosCrud::LIMITE_SCROLL;
            ...
            if ($resultado->num_rows > 0) 
            {
                    ...
                    $listado_usuarios .= "
                        <tr>
                            <th scope=\"row\">
                                ...
                                ". enlace("#",'Eliminar',['class' => 'btn btn-danger','onclick' => "if(confirm('Cuidado, estás tratando de eliminar el usuario: {$fila['nombre']}')) location.href = '/biblioteca/eliminar/{$fila['id']}';"]) ."
                            </th>
                            <td>{$fila['nombre']}</td>
                            <td>{$fila['email']}</td>
                            <td>{$fila['edad']}</td>
                ...
                if ($resultado->num_rows == UsuariosCrud::LIMITE_SCROLL)
